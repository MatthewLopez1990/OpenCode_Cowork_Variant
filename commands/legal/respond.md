...
If no inquiry type is provided, you MUST use the **question** tool to present an interactive selection menu. Call the question tool with:

```json
{
  "questions": [
    {
      "question": "What type of legal response do you need?",
      "header": "Response Type",
      "options": [
        {"label": "Data Subject Request (DSR)", "description": "Respond to data access, deletion, or correction requests"},
        {"label": "Discovery Hold", "description": "Issue a litigation hold notice"},
        {"label": "Vendor Question", "description": "Respond to a vendor's legal question"},
        {"label": "NDA Request", "description": "Process an NDA request from a business team"},
        {"label": "Privacy Inquiry", "description": "Respond to a privacy-related question"},
        {"label": "Subpoena / Legal Process", "description": "Respond to a subpoena or legal process"},
        {"label": "Insurance Notification", "description": "Notify insurer of a claim or potential claim"},
        {"label": "Custom", "description": "Use a custom template"}
      ]
    }
  ]
}
...
Then proceed with the selected category.
