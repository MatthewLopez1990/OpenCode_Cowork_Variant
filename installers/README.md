...
|------|----------|--------------|
| `ChatFortAI.Cowork.Installer_0.1.9_aarch64.dmg` | macOS | Apple Silicon (M1 and newer) |
| `ChatFortAI.Cowork.Installer_0.1.9_x64.dmg` | macOS | Intel |
| `ChatFortAI.Cowork.Installer_0.1.9_x64-setup.exe` | Windows | x64 |
| `ChatFortAI.Cowork.Installer_0.1.9_amd64.AppImage` | Linux | x64 |
