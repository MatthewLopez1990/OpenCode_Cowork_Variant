...
import coworkDarkRaw from './cowork-dark.json';
...
export const coworkDarkTheme = withPrColors(coworkDarkRaw as Theme);

export const DEFAULT_LIGHT_THEME_ID = 'flexoki-light' as const;
export const DEFAULT_DARK_THEME_ID = 'cowork-dark' as const;
...
export function getThemeById(id: string): Theme | undefined {
  ...
  const resolvedId =
    ...
    id === 'spencer-fane-dark' ? 'cowork-dark' :
    id;
