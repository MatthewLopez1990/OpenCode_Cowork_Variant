...
var rootCmd = &cobra.Command{
	Use:   "sf-steward-code",
	Short: "Spencer Fane legal AI assistant for software development",
	Long: `SF Steward Code is a Spencer Fane-branded legal AI assistant powered by the Expedient AI gateway.
It provides an interactive terminal interface with AI capabilities, legal research tools, code analysis,
and LSP integration to assist attorneys and developers directly from the terminal.`,
	Example: `
  ...
  sf-steward-code -d -c /path/to/project

  # Print version
  sf-steward-code -v

  # Run a single non-interactive prompt
  sf-steward-code -p "Research Missouri statute of limitations for breach of contract"

  # Run a single non-interactive prompt with JSON output format
  sf-steward-code -p "Summarize the key holdings in Dobbs v. Jackson" -f json
  `,
